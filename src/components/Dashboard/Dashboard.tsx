      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-semibold text-gray-900">Pets Registered</h3>
      ...
      <div className="mt-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <button className="bg-blue-600 text-white p-6 rounded-lg hover:bg-blue-700 transition-colors text-left">
            ...
            <p className="text-blue-100 mt-2 text-sm">Schedule a grooming session for your pet</p>
          </button>
          ...
          <button className="bg-green-600 text-white p-6 rounded-lg hover:bg-green-700 transition-colors text-left">
            ...
            <p className="text-green-100 mt-2 text-sm">Add or update your pet information</p>
          </button>
          ...
          <button className="bg-purple-600 text-white p-6 rounded-lg hover:bg-purple-700 transition-colors text-left">
            ...
            <p className="text-purple-100 mt-2 text-sm">Update your profile and preferences</p>
          </button>
        </div>
      </div>
    </div>
