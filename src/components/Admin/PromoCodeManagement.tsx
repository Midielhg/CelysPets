    ...
    <div className="bg-gradient-to-br from-amber-50 to-rose-50 rounded-2xl shadow-xl p-6 border border-amber-200/50">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-bold text-amber-900">Promo Codes</h2>
            <p className="text-amber-700">Manage discount codes and promotions</p>
          </div>
        </div>
        <button
          onClick={() => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white/50 rounded-xl p-4 border border-amber-200/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-amber-700">Active Codes</p>
        ...
        <div className="bg-white/50 rounded-xl p-4 border border-amber-200/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-amber-700">Total Usage</p>
              <p className="text-2xl font-bold text-amber-900">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <label htmlFor="active" className="text-sm font-medium text-amber-800">
          ...
          <div className="flex space-x-3 pt-4">
            <button
              ...
              className="flex-1 px-4 py-2 border border-amber-200 text-amber-700 rounded-lg hover:bg-amber-50 transition-colors duration-200"
            >
              Cancel
            </button>
            <button
